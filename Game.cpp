                ...
                if (hetmanOptions == 0) {
                    ...
                    for (int i = 1; i <= hetmanOptionsMap.size(); i++) {
                        ...
                        if (hetmanOptionsMap.find(i)->second.size() == 1) {
                            ...
                            cout << "bicie z " << board.rows[hetmanOptionsMap.find(i)->second.at(1)->getX()] << board.columns[hetmanOptionsMap.find(i)->second.at(1)->getY()] << " na " << board.rows[hetmanOptionsMap.find(i)->second.at(0)->getX()] << board.columns[hetmanOptionsMap.find(i)->second.at(0)->getY()];
                        }
